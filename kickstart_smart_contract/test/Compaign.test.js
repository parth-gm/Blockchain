...
describe('Campaigns', () => {
    ...
    it('marks caller as the campaign manager', async () => {
        const manager = await campaign.methods.manager().call(); // public variable get method is always get created by solidity
        assert.equal(accounts[0], manager);

    });

    it('allows minimum contribute to the campaign', async () => {
